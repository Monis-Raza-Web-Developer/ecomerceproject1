	...
	<section class="sec-product-detail bg0 p-t-65 p-b-60">
		<div class="container">
			...
			if(isset($_GET['detid'])){
				...
				$query->bindParam("pid",$detid);
				$query->execute();
				$row=$query->fetch(PDO::FETCH_ASSOC);
?>
			<form action="shoping-cart.php" method="post">
				<input type="hidden" name="proid" value="<?php echo $row['productid']?>">
				<input type="hidden" name="pnam" value="<?php echo $row['product_name']?>">
				<input type="hidden" name="ppri" value="<?php echo $row['product_price']?>">
					...
					<div class="p-l-25 p-r-30 p-lr-0-lg">
						<div class="wrap-slick3 flex-sb flex-w">
							...
							<div class="slick3 gallery-lb">
								<div class="item-slick3" data-thumb="../dashmin-1.0.0/dashmin-1.0.0/productimg/<?php echo $row['product_image'] ?>">
									<div class="wrap-pic-w pos-relative">
										<img src="../dashmin-1.0.0/dashmin-1.0.0/productimg/<?php echo $row['product_image'] ?>" alt="IMG-PRODUCT">
							...
							<div class="flex-w flex-r-m p-b-10">
								<div class="size-204 flex-w flex-m respon6-next">
									<div class="wrap-num-product flex-w m-r-20 m-tb-10">
										...
										<input class="mtext-104 cl3 txt-center num-product" type="number" name="pqan" value="1">
									...
									<button class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15" name="addcart">
										Add to cart
									</button>
								</div>
							</div>	
...
if(isset($_GET['detid'])){
	...
	$gid=$_GET['detid'];
$query= $pdo->prepare('select * from reviews where productid =:giid');
$query->bindParam('giid',$gid);
$query->execute();
$row=$query->fetchAll(PDO::FETCH_ASSOC);
foreach($row as $rowrev){
?>
                              ...
                              <div class="wrap-pic-s size-109 bor0 of-hidden m-r-18 m-t-6">
									...
									?>
										...
										<form class="w-full" method="post">
											...
											<div class="flex-w flex-m p-t-10 p-b-23">
